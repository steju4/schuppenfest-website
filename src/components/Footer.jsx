...
export default function Footer() {
  return (
    <footer className="relative overflow-hidden bg-night px-5 pb-10 pt-14 text-sand-50">
      ...
      <Reveal className="relative mx-auto max-w-lg text-center">
        ...
        <p className="display mt-5 text-[1.8rem] leading-[1.05] text-sand-50 sm:text-3xl">
          {NEXT.closing}
        </p>
